#declaraÃ§Ã£o colunas de bolas sorteadas
...
#aquisiÃ§Ã£o de quantidade de sorteios por dezena individual em tabelas
...
#impressÃ£o resultados individuais
...
#uniÃ£o de todas as colunas com numeros de sorteios
...
#separaÃ§Ã£o de todas as colunas por valor individual
tabela = table(todos)

#impressÃ£o tabela com valores mais sorteados
plot(tabela, main = "GrÃ¡fico NÃºmero Sorteados",ylab = "Quantidade",xlab = "NÃºmeros Sorteados", ylim = c(0,240), col = "blue")
...
#script para verificaÃ§Ã£o de presenÃ§a de 3 numeros distintos em todas as linhas
X <- 2 #Numero 1 
Y <- 33 #Numero 2
Z <- 55 #Numero 3
...
#quantidade de vezes que sairam os 3 nÃºmeros
print(c)


#Sequencia numeros para alimentaÃ§Ã£o script de verificaÃ§Ã£o
x<-60
y<-59
z<-58
count<-0
...
library(plyr)
#comando para ordenar a lista conforme V4 (numero de vezes da combinaÃ§Ã£o de numeros)
